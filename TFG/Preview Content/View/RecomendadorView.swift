...
struct RecomendadorView: View {
        ...
        ZStack {
            ...
            VStack(spacing: 30) {
                ...
                if usuarioPagado {
                    ...
                    VStack(spacing: 25) {
                        // Horas al día con Stepper estilizado
                        ...
                        // Picker duración con estilo Segmentado personalizado
                        ...
                        // Botón Recomendador con efecto destacado
                        Button(action: {
                            hideKeyboard()
    ...
    func generarRecomendacion() {
        guard let apiKey = obtenerAPIKey() else {
            recomendacion = "Error: No se encontró la API Key."
            return
        }
