...
struct MenuView: View {
    ...
    @State private var userPhotoURL: URL? = Auth.auth().currentUser?.photoURL
    ...
    var body: some View {
        ZStack {
            ...
            // Presentación modal para perfil de usuario
...
//Buenas, te paso feedback: En general guay

//sugerencias de mejora:

 //• menu de usuario -> poner icono de usuario o la foto
 //• menu de usuario -> alinear a la izquierda en vez de a la derecha
 //• parches y favoritos-> asumiendo que ya funciona, ponlo mejor en un carrusel arriba también para seleccionarlo mas visualmente
 //• El plan de pago yo lo metería dentro del perfil
